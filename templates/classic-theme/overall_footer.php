...
<style>
    :root {
        --footer-letter-color: <?php echo $config['footer_letter_color']; ?>;
        --footer-icon-color: <?php echo $config['footer_icon_color']; ?>;
    }
</style>

<div id="footer" <?php echo get_option('disable_landing_page') ? 'class="d-none"' : ''; ?> style="background-color: <?php echo $config['footer_bg_color'] ?>;">
    <div class="footer-middle-section">
        <div class="container" style="color: <?php echo $config['footer_letter_color'] ?> !important;">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12">
                    <div class="footer-logo">
                        <img src="<?php _esc($config['site_url']); ?>storage/logo/<?php _esc($config['site_logo_footer']); ?>" alt="Footer Logo">
                    </div>
                    <p><?php _e($config['footer_text']); ?></p>
                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            // Display links for "My Account" section
                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php url("CONTACT") ?>"><?php _e("Contact Us") ?></a></li>
                            <?php
                            // Display links for "Helpful Links" section
                            foreach ($htmlpages as $html) {
                                if ($html['category'] == "1") {
                                    echo '<li><a href="' . $html['link'] . '">' . $html['title'] . '</a></li>';
                                }
                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            ?>
                            <?php
                            // Display links for "Information" section
                            foreach ($htmlpages as $html) {
                                if ($html['category'] == "2") {
                                    echo '<li><a href="' . $html['link'] . '">' . $html['title'] . '</a></li>';
                                }
                ...
                <div class="col-xl-12">
                    <div class="footer-rows-left">
                        <div class="footer-row">
                            <span class="footer-copyright-text"><?php _e(_esc($config['copyright_text'])); ?></span>
                        </div>
                    </div>
...
<!-- <script>(function () { var pp = document.createElement('script'), ppr = document.getElementsByTagName('script')[0]; stid = 'L0xwU04xTyt2aFc1ZUVmNE9aemdzQT09'; pp.type = 'text/javascript'; pp.async = true; pp.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 's01.live2support.com/dashboardv2/chatwindow/'; ppr.parentNode.insertBefore(pp, ppr); })();</script> -->
</body>
