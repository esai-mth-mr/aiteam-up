                        ...
                        <div class="dashboard-box margin-top-0 margin-bottom-30">
                            ...
                            <div class="headline">
                                ...
                                <?php if (!in_array($ai_template['slug'], $plan_templates)) { ?>
                                    <span class="dashboard-status-button yellow margin-bottom-0 margin-left-10" title="<?php _e("Upgrade your plan to use this template") ?>" data-tippy-placement="top"><i class="fa fa-gift"></i> <?php _e("Pro") ?></span>
                                <?php } ?>
                            </div>
                            <div class="content with-padding">
                                ...
                                ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("What is your blog is about?") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" placeholder="<?php _e("Describe your blog here...") ?>" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    case 'blog-intros':
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Blog Title") ?><span class="form-required">*</span></h6>
                                            <input name="title" class="with-border quick-text-counter small-input" placeholder="<?php _e("Best restaurants in Japan") ?>" data-maxlength="200" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Subheadings") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" placeholder="<?php _e("Subheading 1, subheading 2") ?>" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    case 'article-writer':
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="title" class="with-border quick-text-counter small-input" placeholder="<?php _e("Best restaurants in Japan") ?>" data-maxlength="500" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Keywords") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" placeholder="<?php _e("Keyword 1, keyword 2") ?>" data-maxlength="200" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("What would you like to rewrite?") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border small-input" placeholder="<?php _e("Enter your content to rewrite") ?>" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Keywords") ?><span class="form-required">*</span></h6>
                                            <textarea name="keywords" class="with-border quick-text-counter small-input" data-maxlength="200" placeholder="<?php _e("Keyword 1, keyword 2") ?>"></textarea>
                                        </div>
                                    <?php
                                        break;
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <textarea name="description" class="with-border quick-text-counter small-input" placeholder="<?php _e("Describe your content here...") ?>" data-maxlength="400" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product name") ?><span class="form-required">*</span></h6>
                                            <input name="title" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Audience") ?><span class="form-required">*</span></h6>
                                            <input name="audience" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product Description") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Content") ?><span class="form-required">*</span></h6>
                                            <textarea name="description" class="with-border small-input" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    case 'quora-answers':
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="300" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                    case 'definition':
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="keyword" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                    <?php
                                        break;
                                    case 'emails':
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="recipient" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Recipient Position") ?><span class="form-required">*</span>
                                            </h6>
                                            <input name="recipient-position" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="from" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("To") ?><span class="form-required">*</span>
                                            </h6>
                                            <input name="to" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Goal") ?><span class="form-required">*</span>
                                            </h6>
                                            <input name="goal" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Description") ?><span class="form-required">*</span>
                                            </h6>
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Company Information") ?><span class="form-required">*</span>
                                            </h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Platform") ?></h6>
                                            <select name="platform" class="with-border small-input selectpicker" required>
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("What is this post about?") ?><span class="form-required">*</span>
                                            </h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <textarea name="information" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("What is this post about?") ?><span class="form-required">*</span>
                                            </h6>
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="keywords" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                    <?php
                                        break;
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Website Description") ?><span class="form-required">*</span>
                                            </h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Search Term/Keywords") ?><span class="form-required">*</span>
                                            </h6>
                                            <input name="keywords" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                    <?php
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="company_name" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product Name") ?><span class="form-required">*</span>
                                            </h6>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product/Service Description") ?><span class="form-required">*</span>
                                            </h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="genre" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                    <?php
                                        break;
                                    case 'translate':
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product Description") ?><span class="form-required">*</span>
                                            </h6>
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" required></textarea>
                                        </div>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <input name="question" class="with-border quick-text-counter small-input" data-maxlength="100" required>
                                        </div>
                                        <div class="submit-field margin-bottom-20">
                                            <h6><?php _e("Product Description") ?><span class="form-required">*</span>
                                            </h6>
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="500" required></textarea>
                                        </div>
                                    <?php
                                        break;
                                }
                                    ...
                                    ?>
                                        <div class="submit-field margin-bottom-20">
                                            ...
                                            <?php if ($parameter['type'] == 'textarea') { ?>
                                                <textarea name="parameter[<?php _esc($key) ?>]" class="with-border small-input" placeholder="<?php _esc($parameter['placeholder']) ?>" <?php _esc($required) ?>></textarea>
                                            <?php } else if ($parameter['type'] == 'text') { ?>
                                                <input name="parameter[<?php _esc($key) ?>]" class="with-border small-input" placeholder="<?php _esc($parameter['placeholder']) ?>" <?php _esc($required) ?>>
                                            <?php } else if ($parameter['type'] == 'select') {
                                                $options = explode(',', $parameter['options']);
                                            ?>
                                                <select name="parameter[<?php _esc($key) ?>]" class="with-border small-input selectpicker" <?php _esc($required) ?>>
                                ...
                                <?php if (isset($ai_template['settings']['language']) ? $ai_template['settings']['language'] : 1) { ?>
                                    <div class="submit-field margin-bottom-20">
                                        ...
                                        <select name="language" id="language" class="with-border small-input selectpicker" data-live-search="true" required>
                                ...
                                <?php if (isset($ai_template['settings']['quality_type']) ? $ai_template['settings']['quality_type'] : 1) { ?>
                                    <div class="submit-field margin-bottom-20">
                                        ...
                                        <select name="quality" id="quality" class="with-border small-input selectpicker" required>
                                ...
                                <?php if (isset($ai_template['settings']['tone_of_voice']) ? $ai_template['settings']['tone_of_voice'] : 1) { ?>
                                    <div class="submit-field margin-bottom-20">
                                        <h6><?php _e("Tone of Voice") ?>
                                            <i class="fa fa-question-circle" data-tippy-placement="top" title="<?php _e('Set the tone of the result.') ?>"></i>
                                        </h6>
                                        <select name="tone" id="tone" class="with-border small-input selectpicker" required>
                                ...
                                <div class="submit-field margin-bottom-20">
                                    ...
                                    <select name="no_of_results" id="results" class="with-border small-input selectpicker" required>
                                ...
                                <div class="submit-field margin-bottom-20">
                                    <h6><?php _e("Max Results Length") ?>
                                        <i class="fa fa-question-circle" data-tippy-placement="top" title="<?php _e('Maximum words for each result.') ?>"></i>
                                    </h6>
                                    <input name="max_results" type="number" class="with-border small-input" value="<?php _esc(get_option('ai_default_max_langth')) ?>" min="50">
                                </div>
                                <div>
                                    ...
                                    <?php } else { ?>
                                        <button type="submit" name="submit" class="button ripple-effect full-width"><?php _e("Generate") ?>
                    ...
                    <div class="dashboard-box margin-top-0 margin-bottom-30">
                        ...
                        <div class="headline">
                            ...
                            <div class="margin-left-auto line-height-1">
                                <a href="#" class="button ripple-effect btn-sm" id="export_to_word" data-tippy-placement="top" title="<?php _e("Export as Word Document") ?>"><i class="fa fa-file-word-o"></i></a>
                                <a href="#" class="button ripple-effect btn-sm" id="export_to_txt" title="<?php _e("Export as Text File") ?>" data-tippy-placement="top"><i class="fa fa-file-text-o"></i></a>
                                <a href="#" class="button ripple-effect btn-sm" id="copy_text" title="<?php _e("Copy Text") ?>" data-tippy-placement="top"><i class="fa fa-copy"></i></a>
                            </div>
                        </div>
                        <div class="content with-padding">
                            <form id="ai_document_form" name="ai_document_form" method="post" action="#">
                                ...
                                <div class="d-flex margin-bottom-10">
                                    <input name="title" type="text" class="with-border small-input" value="<?php _e("Untitled Document") ?>" required>
                                    <button class="button btn-sm margin-left-5 ripple-effect" name="submit" type="submit" title="<?php _e("Save Document") ?>" data-tippy-placement="top"><i class="icon-feather-save"></i></button>
                                </div>
