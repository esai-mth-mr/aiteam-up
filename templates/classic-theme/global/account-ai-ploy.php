...
overall_header(__("AI Ployees Marketplace"));
            ...
            <div class="dashboard-box document-box margin-top-0 margin-bottom-30">
                ...
                <div class="content with-padding">
                    <div style="display: flex; align-items: center;">
                        <img class="ai_ployees_marketplace_img_class" src="<?php echo $config['site_url'] . 'storage/banner/' . $config['ai_ployees_marketplace_img'] ?>">
                    </div>
                    <span style="height: 40px; display: block;"></span>
                    <div class="daily_tech_calls_button">
                        <a style="color: white; font-size: 20px; font-weight: bold;" href="<?php echo $config['ai_ployee_marketplace_link'] ?>" target="_blank"><?php _e("Join the Forefront of AI Innovation – Sign Up for Early Access!")?></a>
                    </div>
                </div>
            </div>
