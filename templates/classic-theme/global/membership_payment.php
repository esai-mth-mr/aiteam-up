...
<div class="container" style="display: none;">
    <div class="row">
        <div class="col-xl-8 col-lg-8 content-right-offset">
            <form id="subscribeForm" method="POST" novalidate="novalidate" enctype="multipart/form-data" data-useremail="<?php echo $user['email'] ?>">
                <h3><?php _e("Payment Method") ?></h3>
                <div class="payment margin-top-30">
                    <?php if ($plan_id == "trial") { ?>
                        <div class="payment-tab payment-tab-active">
                            <div class="payment-tab-trigger">
                                <input checked id="trial" name="payment_method_id" type="radio" value="trial" data-name="trial">
                    ...
                    <?php } else { ?>
                        ...
                        if ($user_balance >= $price) { ?>
                            <div class="payment-tab payment-tab-active">
                                <div class="payment-tab-trigger">
                                    <input name="payment_method_id" class="payment_method_id" id="<?php _esc("wallet"); ?>" type="radio" value="wallet" data-name="<?php _esc("wallet"); ?>">
                        ...
                        ?>
                            <div class="payment-tab <?php if ($i == 0) {
                                ...
                                <div class="payment-tab-trigger">
                                    <input name="payment_method_id" class="payment_method_id" id="<?php _esc($payment['folder']); ?>" type="radio" value="<?php _esc($payment['id']); ?>" data-name="<?php _esc($payment['folder']); ?>">
                                    <label for="<?php _esc($payment['folder']); ?>"><?php _esc($payment['title']); ?></label>
                                    <img class="payment-logo <?php _esc($payment['folder']); ?>" src="<?php _esc($payment['image']); ?>" alt="<?php _esc($payment['title']); ?>">
                                </div>
                                <div class="payment-tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="radio">
                                                        ...
                                                        <label for="recurring-stripe"><span class="radio-label"></span> <?php _e("Recurring Payment") ?>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="radio">
                                                        ...
                                                        <label for="one-time-stripe"><span class="radio-label"></span> <?php _e("One Time Payment") ?>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="radio">
                                                        ...
                                                        <label for="recurring"><span class="radio-label"></span> <?php _e("Recurring Payment") ?>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="radio">
                                                        ...
                                                        <label for="one-time"><span class="radio-label"></span> <?php _e("One Time Payment") ?>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <table class="default-table table-alt-row PaymentMethod-infoTable">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h4 class="PaymentMethod-heading">
                                                                <strong><?php _e("Payment Proof") ?> *</strong>
                                                            </h4>
                                                            ...
                                                            <div class="uploadButton margin-bottom-20 margin-top-10">
                                                                <input class="uploadButton-input" type="file" accept="images/*" id="payment_proof" name="payment_proof" required />
                                                                <label class="uploadButton-button ripple-effect" for="payment_proof"><?php _e('Upload Image') ?></label>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 class="PaymentMethod-heading">
                                                                <strong><?php _e("Reference") ?></strong>
                                                            </h4>
                                        ...
                                        <div class="row payment-form-row">
                                            <div class="col-12">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutCardNumber" placeholder="<?php _e("CARD NUMBER") ?>" autocomplete="cc-number" autofocus />
                                                </div>
                                            </div>
                                            <div class="col-7">
                                                <div class="card-label form-group">
                                            ...
                                            <div class="col-7">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutCardFirstName" placeholder="<?php _e("First Name") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-5 pull-right">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutCardLastName" placeholder="<?php _e("Last Name") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-7">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutBillingAddress" placeholder="<?php _e("Address") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-5 pull-right">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutBillingCity" placeholder="<?php _e("City") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutBillingState" placeholder="<?php _e("State") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-4 pull-right">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutBillingZipcode" placeholder="<?php _e("Zip code") ?>" />
                                                </div>
                                            </div>
                                            <div class="col-4 pull-right">
                                                <div class="card-label form-group">
                                                    <input type="text" class="form-control" name="checkoutBillingCountry" placeholder="<?php _e("Country") ?>" />
                                                </div>
                                            </div>
                ...
                <button type="submit" name="Submit" class="button big ripple-effect margin-top-40 margin-bottom-65 subscribeNow" id="subscribeNow"><?php _e("Submit") ?></button>
            </form>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function payWithStripe() {
            ...
            Stripe.card.createToken(ccData, function stripeResponseHandler(status, response) {
                if (response.error) {
                    ...
                    /* Insert the token into the form so it gets submitted to the server */
                    $form.append($('<input type="hidden" name="stripedddeToken" />').val(stripeToken));
        ...
        function update_billed_type(billedType) {
        ...
        $('#subscribeForm').on('submit', function(e) {
            ...
            var upgrade = $form.find('[name="upgrade"]').val();
            var billedType = $form.find('[name="billed-type"]').val();

            let email = $('#subscribeForm').data('useremail');
            ...
            if (upgrade == 3) {
                if (billedType == "monthly") {
                    ...
                    formData.append("billed_type", "monthly");
                    formData.append("group_id", "3");
                    $.ajax({
                        type: "POST",
                        url: ajaxurl + "?action=update_billed_type",
                        data: formData,
                        dataType: "json",
                        cache: false,
                        contentType: false,
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                location.href = `https://buy.stripe.com/5kAbMJ2P10dL9bycMR?prefilled_email=${email}`;
                            }
                        },
                    });

                } else if (billedType == "annually") {

                    var formData = new FormData();
                    formData.append("group_id", "3");
                    formData.append("billed_type", "annually");
                    $.ajax({
                        type: "POST",
                        url: ajaxurl + "?action=update_billed_type",
                        data: formData,
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                location.href = `https://buy.stripe.com/3csg2Z3T57GdgE0cMS?prefilled_email=${email}`;
                            }
                        },
                    });
                }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                location.href = `https://buy.stripe.com/5kAdUR61d2lTfzW5kn?prefilled_email=${email}`;
                            }
                        },
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                location.href = `https://buy.stripe.com/28oeYVexJ3pXfzW4gk?prefilled_email=${email}`;
                            }
                        },
                    });
                }
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                if(serverName == 'localhost'){
                                    location.href = `https://buy.stripe.com/test_28o8Ao3F52mw89yfYZ?prefilled_email=${email}`;
                                }else{
                                    location.href = `https://buy.stripe.com/bIY18575h2lT2NabII?prefilled_email=${email}`;
                                }
                            }
                        },
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (!response.success) {
                                ...
                                location.href = `https://buy.stripe.com/14keYVfBN6C9fzW002?prefilled_email=${email}`;
                            }
                        },
                    });
                }
            ...
            // location.href = "https://buy.stripe.com/3csg2Z3T57GdgE0cMS";
        });
