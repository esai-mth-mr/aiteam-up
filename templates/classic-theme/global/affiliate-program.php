<?php
overall_header(__("Partner Program"));
?>
    <!-- Dashboard Container -->
        ...
        <div class="dashboard-content-container" data-simplebar>
            <div class="dashboard-content-inner">
                ...
                <div class="dashboard-box main-box-in-row">
                    <div class="headline">
                        <h3>
                            <i class="icon-feather-share-2"></i> <?php _e("Start earning with the Partner Program"); ?>
                        </h3>
                    </div>
                    <div class="content with-padding">
                        <div class="notification notice">
                            <?php _e('Invite new customers to our site using your partner link and when they purchase any membership plan, you will get a commission.') ?>
                        </div>
                        <div class="margin-top-30">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="bidding-widget margin-bottom-30">
                                        <!-- Headline -->
                                        <span class="bidding-detail"><?php _e('Partner <strong>Rule</strong>') ?></span>
                                ...
                                <div class="col-md-6">
                                    <h4 class="margin-bottom-10"><?php _e('Partner URL') ?></h4>
                                    <div class="d-flex">
                ...
                <div style="margin-bottom: 20px;" class="dashboard-box main-box-in-row" id="video-container">
                    <!-- <div class="headline">
                        <h3>
                    ...
                    <div style="text-align: center; width: 100%; height: auto; margin-bottom: 20px; margin-top: 20px; margin-left: 1.5%;">
                            <img class="redux-option-image" id="banner" style="border-radius: 10px;"
                                src="<?php echo $config['site_url'].'storage/banner/'. $config['home_banner']?>"
                                alt="" target="_blank">
                    </div>
                </div>
