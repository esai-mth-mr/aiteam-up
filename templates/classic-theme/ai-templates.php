    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner">
            ...
            <div class="template-categories">
                <ul>
                    <li class="active"><a href="javascript:void();" class="ai-templates-category" data-category="all"><?php _e("All templates") ?></a></li>
                    <?php
                    ...
                    ?>
                            <li>
                                <a onclick=hide_template_block(this) class="ai-templates-category" data-category="<?php _esc($category['id']) ?>">
                                    <?php echo !empty($translations[$config['lang_code']]['title'])
                                        ? _e($translations[$config['lang_code']]['title'])
                                        : _e($category['title']); ?>
                                </a>
                            </li>
                    <?php }
                    ...
                    ?>
                            ...
                            ?>
                                <div class="col-md-4 col-sm-6 category-<?php _esc($category['id']) ?>">
                                    <a href="<?php echo url('AI_TEMPLATES', false) . '/' . $template['slug'] ?>" <?php if (!in_array($template['slug'], $plan_templates)) { ?> title="<?php _e("Upgrade your plan to use this template") ?>" data-tippy-placement="top" <?php } ?>>
