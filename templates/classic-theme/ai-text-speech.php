...
overall_header(__("AI Voiceover"));
        ...
        <div class="dashboard-content-inner">
            ...
            <form id="ai_text_speech" name="ai_text_speech" method="post" action="#">
                <div class="submit-field margin-bottom-10">
                    <h6><?php _e("Text") ?></h6>
                    <textarea name="description" class="with-border" maxlength="3000" required></textarea>
                </div>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="submit-field margin-bottom-20">
                            <h6><?php _e("Title") ?></h6>
                            <input name="title" class="with-border small-input" type="text" value="<?php _e("New Audio") ?>">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="submit-field margin-bottom-20">
                            <h6><?php _e("Language") ?></h6>
                            <select name="language" id="language" class="with-border small-input" required>
                    ...
                    <div class="col-sm-3">
                        <div class="submit-field margin-bottom-20">
                            <h6><?php _e("Pause") ?></h6>
                            <select name="pause" id="pause" class="with-border small-input" required>
                ...
                <div style="display: flex; justify-content: space-between;">
                    <button type="submit" name="submit" id="generateButton" class="speech-text button ripple-effect">
                        <?php _e("Generate") ?>
                    ...
                    <div style="display: flex;">
                        <div class="audio-container" style="display: none;">
                            <audio class="preview_audio" style="height: 30px;" controls="" preload="none">
                                <source src="" type="audio/mpeg">
                            </audio>
                        </div>
                        <button type="submit" name="preview" id="previewButton" class="speech-text button ripple-effect">
                            <?php _e("Preview") ?>
                            <i class="fa fa-volume-up"></i>
                        </button>
                        <!-- <div style="display: flex;">
                            <h4>Preview</h4>    
                            <button type="submit" name="preview" id="previewButton" class="speech-text preview-speech ripple-effect" title="Preview" id="previewButton">
                                <i class="fa fa-volume-up"></i>
                            </button>
                        </div> -->
                    </div>
                    <!-- <button onclick="previewSpeech()" id="previewButton" class="preview-speech ripple-effect" title="Preview">
                        <i class="fa fa-volume-up"></i>
                    </button> -->
                </div>
                <div>
                                ...
                                <tr>
                                    ...
                                    <td data-label="<?php _e("Audio") ?>">
                                        <audio controls="" preload="none">
                                            <source src="<?php _esc($speech['file_url']) ?>" type="audio/mpeg">
                                        </audio>
                                    </td>
                                    ...
                                    <td data-label="<?php _e("Action") ?>">
                                        <a href="<?php _esc($speech['file_url']); ?>" class="button ripple-effect btn-sm" data-tippy-placement="top" title="<?php _e("Download") ?>" download><i class="fa fa-download"></i>
                                        </a>
                                        <a href="#" class="button red ripple-effect btn-sm quick-delete" data-id="<?php _esc($speech['id']) ?>" data-action="delete_speech" data-tippy-placement="top" title="<?php _e("Delete") ?>"><i class="fa fa-trash-o"></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php } ?>
