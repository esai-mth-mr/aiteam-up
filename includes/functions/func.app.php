...
function get_opeai_models()
{
    return array(
        ...
        'gpt-4-turbo-preview' => __('ChatGPT 4 Turbo'),
    );
}
...
function get_ai_chat_responsive() {
    return array(
        "Academic",
        "Analytical",
        "Argumentative",
...
function getUserSidebarMenus($slug=''){
    $userPermissions = [
        "launchpad"=> ["title"=>"Launchpad","icon"=>"<i class='fa fa-arrow-circle-o-up'></i> "],
        "dashboard"=> ["title"=>"Dashboard","icon"=>"<i class='fa fa-th-large'></i> "],
        "conversations"=> ["title"=>"Conversations","icon"=>"<i class='fa fa-comment-o'></i> "],
        "calendars"=> ["title"=>"Calendars","icon"=>"<i class='fa fa-calendar'></i> "],
        "contacts"=> ["title"=>"Contacts","icon"=>"<i class='fa fa-users'></i> "],
        "opportunities"=> ["title"=>"Opportunities","icon"=>"<i class='fa fa-snowflake-o'></i> "],
        "payments"=> ["title"=>"Payments","icon"=>"<i class='fa fa-usd'></i> "],
        "marketing"=> ["title"=>"Marketing","icon"=>"<i class='fa fa-paper-plane-o'></i> "],
        "automation"=> ["title"=>"Automation","icon"=>"<i class='fa fa-repeat'></i> "],
        "sites"=> ["title"=>"Sites","icon"=>"<i class='fa fa-globe'></i> "],
        "memberships"=> ["title"=>"Memberships","icon"=>"<i class='fa fa-certificate'></i> "],
        "reputation"=> ["title"=>"Reputation","icon"=>"<i class='fa fa-star-o'></i> "],
        "reporting"=> ["title"=>"Reporting","icon"=>"<i class='fa fa-line-chart'></i> "],
        "app-marketplace"=> ["title"=>"App Marketplace","icon"=>"<i class='fa fa-th'></i> "]
    ];
    if(!empty($slug)){
        return !empty($userPermissions[$slug])?$userPermissions[$slug]:"";
    }
