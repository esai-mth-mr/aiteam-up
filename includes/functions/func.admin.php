...
function send_admin_message_notification($ticket_id, $user_email, $title, $message) {
    ...
    $email_subject = "Admin is sending a message on Ticket";
    ...
    return email_send($user_email, $config['admin_email'], $email_subject, $email_body);
}