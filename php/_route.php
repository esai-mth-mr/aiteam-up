...
$router->map('GET|POST','/temp-pricing', 'global/temp-pricing.php');
...
$router->map('GET|POST','/all-chat/?', 'app/all-chat.php');
$router->map('GET|POST','/all-images/?', 'app/all-image.php');
$router->map('GET|POST','/all-templates/?', 'app/all-templates.php');
$router->map('GET|POST','/all-speech-to-text/?', 'app/all-speech-to-text.php');
...
$router->map('GET|POST','/custom-support/?', 'global/custom-support.php');
$router->map('GET|POST','/uai/?', 'app/uai.php');
$router->map('GET|POST','/uai/chat-history/?', 'app/uai-chat-history.php');
$router->map('GET|POST','/account-live-tech/?', 'global/account-live-tech.php');
$router->map('GET|POST','/account-ai-ploy/?', 'global/account-ai-ploy.php');
$router->map('GET|POST','/embed-chat/?', 'app/embed-chat.php');