    ...
    <div class="slidePanel-inner">
        <form method="post" id="sidePanel_form" data-ajax-action="editPrepaidPlan">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label for="ai_text_to_speech_limit"><?php _e('AI Voiceover Characters') ?></label>
                    ...
                    <span class="form-text text-muted"><?php _e('Set the characters limit for AI Voiceover.') ?></span>
                </div>
