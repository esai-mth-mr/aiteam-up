    ...
    <form method="post" class="ajax_submit_form" data-action="SaveSettings"
        ...
        <div class="quick-card card">
            ...
            <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="ai_image_api" id="ai_image_api"
                                        ...
                                        <option value="dall-e-3" <?php if ('dall-e-3' == get_option('ai_image_api')) echo 'selected'; ?>><?php _e('DALL E 3') ?></option>
                                </select>
                ...
                <div class="mt-4">
                    <h4 class="text-primary"><?php _e('AI Voiceover') ?></h4>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <?php quick_switch(__('Enable AI Voiceover'), 'enable_text_to_speech', (get_option("enable_text_to_speech") == '1')); ?>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
