                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="admin_email">
                                <?php _e('Admin Email') ?>
                                <i class="icon-feather-help-circle" title="<?php _e('This is the email address that the contact and report emails will be sent to.') ?>" data-tippy-placement="top"></i>
                            </label>
                            <div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="support_email">
                                <?php _e('Support Email') ?>
                                <i class="icon-feather-help-circle" title="<?php _e('This is the email address for the support.') ?>" data-tippy-placement="top"></i>
                            </label>
                            <div>
                                <input name="support_email" class="form-control" type="text" id="support_email" value="<?php echo get_option("support_email"); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div>
                                <input name="email_pub_key" class="form-control" type="text" id="email_pub_key" value="<?php echo get_option("email_pub_key"); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div>
                                <input name="email_pri_key" class="form-control" type="text" id="email_pri_key" value="<?php echo get_option("email_pri_key"); ?>">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-sm-12">
