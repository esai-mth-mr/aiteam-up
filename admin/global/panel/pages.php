            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="type" class="form-control">
                        <option value="0" <?php if($info['category'] == '0') echo "selected"; ?>><?php _e('My Account') ?></option>
                        <option value="1" <?php if($info['category'] == '1') echo "selected"; ?>><?php _e('Helpful Links') ?></option>
                        <option value="2" <?php if($info['category'] == '2') echo "selected"; ?>><?php _e('Information') ?></option>
                    </select>
                </div>
                <div class="form-group">
