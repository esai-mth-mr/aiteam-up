        ...
        <form method="post" id="sidePanel_form" data-ajax-action="addMembershipPlan">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input name="ai_uai_agent_limit" type="number" class="form-control" id="ai_uai_agent_limit" value="">
                    <span class="form-text text-muted"><?php _e('Set -1 for unlimited.') ?></span>
                </div>
                <div class="form-group">
                    <label for="ai_voices_limit"><?php _e('AI Voices') ?></label>
                    <input name="ai_voices_limit" type="number" class="form-control" id="ai_voices_limit" value="">
                    <span class="form-text text-muted"><?php _e('Set -1 for unlimited.') ?></span>
                </div>
