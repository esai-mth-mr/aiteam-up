                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $rows = ORM::for_table($config['db']['pre'] . 'support')
                                            ->order_by_desc('id')
                                            ->limit(5)
                                            ->find_many();
                                        ...
                                        ?>
                                            <tr>
                                                <td class="text-truncate"><?php _esc($info['id']); ?></td>
                                                <td><span class="label label-info label-rounded"><?php _esc($info['title']); ?></span> </td>
                                                <td ><?php _esc( strlimiter(strip_tags((string) $info['content']), 50)) ?></td>
                                                <td><?php _esc($info['category']); ?></td>
                                                <td><span class="ticket-status priority-<?php echo strtolower($info['priority']); ?>"><?php _esc($info['priority']) ?></span></td>
                                                <td >
                                                    <?php if ($info['status'] === "open") { ?>
                                                        <span class="ticket-status ticket-status-open"><?php _esc($info['status']) ?></span>
                                                    <?php } else if ($info['status'] === "progress") { ?>
                                                        <span class="ticket-status ticket-status-progress"><?php _esc($info['status']) ?></span>
                                                    <?php } else { ?>
                                                        <span class="ticket-status ticket-status-resolved"><?php _esc($info['status']) ?></span>
                                                    <?php } ?>
                                                </td>
                                ...
                                <a href="<?php echo ADMINURL; ?>global/tickets.php"><?php _e('Check all Tickets') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
