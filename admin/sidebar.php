        ...
        <ul class="iconMenu-bar custom-scrollbar">
            ...
            <li data-page="ai-chat-bots">
                <a class="bar-icons" href="<?php echo ADMINURL; ?>app/ai-chat-bots.php">
                    ...
                    <span><?php _e('AI Team') ?></span>
                </a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                    <li class="iconbar-header"><?php _e('AI Team') ?></li>
                    <li><a href="<?php echo ADMINURL; ?>app/ai-chat-bots.php" data-page="ai-chat-bots"><?php _e('AI Team') ?></a></li>
            ...
            <li data-page="settings">
                ...
                <ul class="iconbar-mainmenu custom-scrollbar nav">
                    ...
                    <li>
                        <a href="#quick_affiliate_settings" data-toggle="tab"><?php _e('Partner Program') ?></a>
                    </li>
                    <li>
