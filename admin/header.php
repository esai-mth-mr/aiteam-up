...
<head>
    ...
    <meta name="author" content="AITeamUp" />
...
<!-- Page Header Start-->
<div class="page-main-header" style="background-color : #fff">
    <div class="main-header-right">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="<?php _esc(ADMINURL) ?>"><img src="<?php echo $config['site_url'].'storage/logo/'. $config['site_logo']?>" alt="" height="42"></a></div>
        </div>
